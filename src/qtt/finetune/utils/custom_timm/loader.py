...
def create_loader(
    ...
    Args:
        ...
        trivial_augment: Use TrivialAugmenta.
        rand_augment: Use RandAugment.
        ra_num_ops: Number of transformations in RandAugment.
        ra_magnitude: Magnitude for all the transformations in RandAugment.
